...
from comparisons.rpa_search.src.methods.random_search import run_random_search
...
def main() -> None:
    ...
    if args.workers is not None:
        config["search"]["random_workers"] = int(args.workers)
    ...
    run_random_search(config, run_dir, method, run_id, components)
