...
from comparisons.rpa_search.src.methods.circuitree_runner import run_circuitree
...
def main() -> None:
    ...
    if args.workers is not None:
        config["search"]["circuitree_workers"] = int(args.workers)
    method = "circuitree"
    ...
    run_circuitree(config, run_dir, method, run_id, components)
