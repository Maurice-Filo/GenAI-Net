...
CAMPAIGN_ID=local-qwen35-9b-rpa-default100-20seed-r2
...
log "Launching the Qwen3.5-9B RPA default-policy campaign."
"$ROOT/.venv/bin/python" \
    ...
    --method-name genai_net_llm_qwen35_9b_rpa_default100 \
    --run-suffix cvode_llm_qwen35_9b_rpa_default100 \
    --dsh-home "$DSH_HOME" \
    --workspace-root "$CAMPAIGN_ROOT" \
    --comet-project genai-net-local-llm-paper \
    --skip-postprocessing

log "Qwen3.5-9B RPA campaign completed."
