...
setuptools.setup(
   ...
   install_requires=['wheel', 'torch', 'gymnasium', 'numpy', 'matplotlib', 'tqdm', 'scipy', 'openpyxl', 'pytorch_lightning', 'comet-ml', 'torchrl', 'networkx', 'seaborn', 'joblib', 'scikit-learn', 'scikit-sundae'],
