...
if train_flag:
    ...
    for i in tqdm(range(epoch_num)):
        ...
        agent.update(rewards, step_iteration=i, hof=mult_env.hall_of_fame, observer=observer, tensorizer=tensorizer, stepper=stepper, use_sil=False, sil_weighting_scheme='uniform', sil_batch_size=None)
