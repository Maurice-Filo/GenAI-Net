...
logger = CometLogger(
    api_key=api_key,
    project="multistability_2species_8rxns_MAK_REINFORCE",        
    workspace="maurice-filo", 
    name=f'multistability_2species_8rxns_MAK_REINFORCE_{timestamp}',
)
...
file_name = "multistability_2species_8rxns_MAK_REINFORCE.xlsx"                           # Filename for saving the Excel sheet
