    ...
    def __init__(self, distribution, backbone_attributes, device='cpu'):
        ...
        if distribution["type"] == 'normal':
            ...
            try:
                ...
                raise ValueError("For 'normal' distribution, 'dim' must be specified in the distribution dictionary.")
            D = int(distribution_dim)
            self.distribution_dim = D

            # Define the backbone network that outputs the parameters of the normal distribution
