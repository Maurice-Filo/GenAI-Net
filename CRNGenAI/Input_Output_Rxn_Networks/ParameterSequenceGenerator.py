...
class ParameterSequenceGenerator(torch.nn.Module):
    def __init__(self, IOCRN, parameter_grid, LSTM_hidden_size, FFNN_hidden_size, FFNN_num_layers, num_samples=1, weight=None):
        ...
        self.map_index_to_parameter = map_index_to_parameter
        
    def forward(self, h0, c0, manifold_dim):
        indices, total_logP, total_entropy, h, c = self.model(h0, c0, index_start=manifold_dim)
