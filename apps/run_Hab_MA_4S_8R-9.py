...
default_checkpoint_path = 'habituation_hallmarks_custom_chkpt_run_MA_4S_8R-9.pkl'
...
h4_kwargs = {
    ...
    'recovery_tolerance': h2_kwargs['recovery_tolerance'],
    'max_gap': h2_kwargs['max_gap'],
    'search_depth': h2_kwargs['search_depth'],
}
