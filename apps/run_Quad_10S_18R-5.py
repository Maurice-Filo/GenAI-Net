...
species_labels = ['X_1', 'X_2', 'X_3', 'X_4', 'X_5', 'X_6', 'X_7', 'X_8', 'X_9', 'X_10']
...
cfg.policy.entropy_weights_per_head = {"structure": 5.0, "continuous": 1.0, "discrete": 0.0, "input_influence": 0.0}
...
# %%
checkpoint_path = "Quadratic_task_chkpt_run-2.pkl"
