...
cfg.policy.entropy_weights_per_head = {"structure": 4.0, "continuous": 1.0, "discrete": 0.0, "input_influence": 0.0}
...
# %%
checkpoint_path = 'habituation_hallmarks_custom_chkpt_run_Hab_CMM_6S_12R-2.pkl'
