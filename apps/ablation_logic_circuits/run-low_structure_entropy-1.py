...
cfg.policy.entropy_weights_per_head = {'structure': 1.0, 'continuous': 1.0, 'discrete': 0.0, 'input_influence': 0.0}
...
task_name = "Logic_Circuit_Ablation_Low_Structure_Entropy"
...
# %%
checkpoint_path = "run-low_structure_entropy-1.pkl"
