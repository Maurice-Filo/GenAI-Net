...
cfg.policy.entropy_weights_per_head = {'structure': 0.1, 'continuous': 1.0, 'discrete': 0.0, 'input_influence': 0.0}
...
task_name = "Logic_Circuit_Ablation_Lower_Structure_Entropy"
...
# %%
checkpoint_path = "run-lower_structure_entropy-1.pkl"
