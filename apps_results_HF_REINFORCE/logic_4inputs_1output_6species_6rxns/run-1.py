...
logger = CometLogger(
    api_key=api_key,
    project="logic_4inputs_1output_6species_6rxns_HF_REINFORCE",        
    workspace="maurice-filo", 
    name=f'logic_4inputs_1output_6species_6rxns_HF_REINFORCE_{timestamp}',
)
...
file_name = "logic_4inputs_1output_6species_6rxns_HF_REINFORCE.xlsx"            # Filename for saving the Excel sheet
