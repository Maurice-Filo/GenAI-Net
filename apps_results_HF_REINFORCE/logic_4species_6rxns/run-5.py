...
crn_template.atol = 1e-9
crn_template.rtol = 1e-9
print("Template CRN:")
print(crn_template)

# Construct the library of possible reactions
library = construct_hill_production_library(species_labels=species_labels, max_product_order=1, max_num_regulators=1)
...
entropy_scheduler = {                                   # Entropy scheduler parameters 
    'entropy_weight': 5e-4 ,                            # Global entropy weight
    'entropy_weight_structure_head': 3.0,               # Entropy weight for the structure head
