...
task_name = "Comparator_4s_4r_MAK_REINFORCE"
...
ic = IC(names=species_labels, values=[[0.01, 0.01, 0.01, 0.01]]) # non-zero initial conditions for all species
