...
logger = CometLogger(
    api_key=api_key,
    project="testing_ordering_RPA_3s_5r_MAK_REINFORCE",        
    workspace="redsnic", 
    name=f'testing_ordering_RPA_3s_5r_MAK_REINFORCE_{timestamp}',
)
...
file_name = "testing_ordering_RPA_3s_5r_MAK_REINFORCE.xlsx"             # Filename for saving the Excel sheet
